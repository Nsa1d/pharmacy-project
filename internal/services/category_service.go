...
type CategoryService interface {
	...
	CreateSubCategory(req models.SubCategory) (*models.SubCategory, error)
}
...
func (s *categoryService) CreateSubCategory(req models.SubCategory) (*models.SubCategory, error) {
